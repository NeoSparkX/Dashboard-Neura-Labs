...
function AgreementPdfDoc({ agreement, clientName }: { agreement: Agreement; clientName: string }) {
  ...
  const bodyText: Record<string, string> = {
    "Non-Disclosure Agreement (NDA)": `This Non-Disclosure Agreement ("Agreement") is entered into between Neosparkx and ${clientName}. Both parties agree to maintain the confidentiality of any proprietary information shared during the course of their business relationship. This agreement shall remain in effect for the duration specified and cannot be terminated without mutual written consent.`,
    "Master Service Agreement": `This Master Service Agreement ("MSA") governs the ongoing service relationship between Neosparkx and ${clientName}. It outlines the general terms under which individual Statements of Work will be executed. Both parties agree to act in good faith and comply with all applicable laws throughout the engagement.`,
    "Project Statement of Work (SOW)": `This Statement of Work ("SOW") defines the specific deliverables, timelines, and responsibilities for the project engagement between Neosparkx and ${clientName}. Scope changes must be agreed upon in writing and may be subject to additional fees.`,
    "Retainer Contract": `This Retainer Agreement ensures that ${clientName} has access to Neosparkx' services on a recurring basis. Monthly retainer fees are due in advance and grant access to the agreed scope of services as outlined in the accompanying service schedule.`,
  };
  const body = bodyText[agreement.type] ?? `This ${agreement.type} ("Agreement") is entered into between Neosparkx and ${clientName}. Both parties agree to the terms and conditions set forth in this document and commit to fulfilling their respective obligations in good faith.`;
    ...
    <Document>
      <Page size="A4" style={pdfStyles.page}>
        <View style={pdfStyles.header}>
          ...
          <Text style={pdfStyles.subtitle}>Neosparkx · {today}</Text>
        </View>
        ...
        <View style={pdfStyles.signBlock}>
          <View style={pdfStyles.signRow}>
            <View style={pdfStyles.signCol}>
              ...
              <Text style={pdfStyles.label}>Authorized Signature — Neosparkx</Text>
        ...
        <Text style={pdfStyles.footer}>
          This document is legally binding upon execution by both parties. Generated by Neosparkx Dashboard.
        </Text>
      </Page>
    </Document>
  );
